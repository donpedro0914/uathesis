        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="menuForm" action="{{ route('pos.add.customer') }}" method="post">
                        @csrf
                        <input type="hidden" name="store_id" value="{{ Auth::user()->store_id }}" />
                        <div class="form-row">
                            <h5 class="col-12">Customer Information</h5>
                            <div class="form-group col-md-6 col-xs-12">
                                <label>Suki Code</label> <span class="codecheck_new"></span>
                                <input type="text" id="suki_code_new" class="form-control" name="suki_code" required pattern=".{4,}" title="4 characters minimum"/>
                            </div>
                            <div class="form-group col-md-6 col-xs-12">
                            ...
                            <div class="form-group col-md-6 col-xs-12">
                                <label>Age</label>
                                <input type="text" class="form-control num-only" name="age" required/>
                            </div>
                            <div class="form-group col-md-6 col-xs-12">
                                <label>Bday</label>
                                <input type="text" class="form-control date_filter" name="bday" required/>
                            </div>
                            <div class="form-group col-md-6 col-xs-12">
