<div id="reserve" class="modal fade" aria-labelledby="addTherapist">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="menuForm" action="{{ route('sup.reserve.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8 col-xs-12">
                            ...
                            <select name="inventory_item" class="form-control select2" id="inventory_name">
                        ...
                        <div class="form-group col-md-8 col-xs-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="trans_price" readonly />
                            </div>
                        </div>
