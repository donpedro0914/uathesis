<div id="addBrandPartnerManager" class="modal fade" aria-labelledby="addTherapist">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="brandpartnerForm" action="{{ route('manager.brandpartner.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
